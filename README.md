...
I continue to enhance the application that we will see how we can convert a synchronous action creator into an asynchronous action creator using Redux Middleware Thunk.
